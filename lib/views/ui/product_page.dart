...
class ProductPage extends StatefulWidget {
  const ProductPage({super.key, required this.bracelets});

  final Products bracelets;
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: PageView.builder(
                          ...
                          itemCount: widget.bracelets.imageUrl.length,
                              ...
                              children: [
                                Container(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: widget.bracelets.imageUrl[index],
                                    fit: BoxFit.contain,
                                  ),
                                ),
                                Positioned(
                                ...
                                Positioned(
                                    ...
                                    child: Row(
                                      ...
                                      children: List<Widget>.generate(
                                          widget.bracelets.imageUrl.length,
                                          (index) => Padding(
                                                padding:
